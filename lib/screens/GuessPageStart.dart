...
class _GuessePageState extends State<GuessePage> {
  ...
  Widget build(BuildContext context) {
    ...
    final _scaffoldKeyGuess = GlobalKey<ScaffoldState>();
    ...
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: AppBar(
          leading: InkWell(
            onTap: () {
              _scaffoldKeyGuess.currentState.openDrawer();
            },
  ...
  return  StreamBuilder(
        stream: webservices.getQuestionStream(widget.music_snapshots.id),
                                  ...
                                  webservices.login_state == false
                                    ...
                                    onTap: () {
                                      if (form_key.currentState
                                        ...
                                        try{
                                          var total_list = [];
                                          total_list.add(index);
                                          if (index + 1 !=
                                              products.length) {
                                            webservices
                                                .Login_SetState();
                                            webservices.PostAnswer(
                                                context: context,
                                                userid:webservices.userid.toString(),
                                                date: date_utils.getCurrentDate2Format().toString(),
                                                email: userDocument['Email']??'UNKNOWN',
                                                name: userDocument['Name']??'UNKNOWN',
                                              point: answer == products[index].answer? 5 + userDocument['points']:1 + userDocument['points'],
                                            ).then((value) =>
                                                showNextQuestion(
                                                    context,
                                                    _controller,
                                            ...
                                            webservices.PostAnswer(
                                              ...
                                              name: userDocument['Name']??'UNKNOWN',
                                                ...
                                                dialog
                                                    .showGameSuccess(context)).then((value) => webservices.PostMyGuess(
                                              context: context,
                                              AlbumName: widget.music_snapshots.AlbumName ,
                                              MusicToken:  widget.music_snapshots.MusicToken,
                                              MusicUrl:  widget.music_snapshots.MusicUrl,
                                              collection: 'MyGuesses',
                                              MusicLength:  widget.music_snapshots.MusicLength,
                                              userid: webservices.userid,
                                              TrackName:  widget.music_snapshots.TrackName,
                                            ));
                                          }
                                        }catch(e){
                                          webservices
