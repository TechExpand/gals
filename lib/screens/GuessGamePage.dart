        ...
        body: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(children: [
              ...
              StreamBuilder(
                stream: webservices.getQuestionStream(widget.snapshots.id),
                            ...
                            Align(
                              ...
                              child: Padding(
                                ...
                                child: Row(
                                    children: [
                                  Flexible(
                                      child: products[index].LineOne.toString().toLowerCase()!='guess'?Text(
                                  ...
                                  Flexible(
                                      child: products[index].LineTwo.toString().toLowerCase()!='guess'?Text(
                                  ...
                                  Flexible(
                                      child: products[index].LineThree.toString().toLowerCase()!='guess'?Text(
