...
import 'package:gal/screens/Admin/Edit/EditSlidder2.dart';
import 'package:gal/screens/HomeTabs/Home.dart';
import 'package:provider/provider.dart';



class AdminSlidder2 extends StatefulWidget {


  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return AdminSlidder2State();
  }
}

class AdminSlidder2State extends State<AdminSlidder2> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: Text('Slidder2', style: TextStyle(color:Color(0xFF340c64) ),),
          elevation: 10,
          leading: InkWell(
            onTap: (){
          ...
          body: StreamBuilder(
            stream:  Provider.of<Network>(context, listen: false).getCarouselStream1(),
                                         ...
                                         builder: (context, webservices,child ){
                                          ...
                                          child: webservices.login_state==false?RaisedButton(
                                            ...
                                            onPressed: () {
                                             ...
                                             webservices.Delete(context:context, id:id, collection:'CarouselMusic1');
                                            },
                                            child: Text(
