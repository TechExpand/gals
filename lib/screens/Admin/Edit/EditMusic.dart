...
class EditMusic extends StatelessWidget {
  var edit_id;
  var edit_albumname;
 var edit_tracktitle;
 var edit_musictoken;
    ...
    return  Scaffold(
      ...
      bottomNavigationBar:  BottomNavigationWidget(),
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: Text('Edit Music', style: TextStyle(color: Color(0xFF340c64)),),
          elevation: 10,
          leading: InkWell(
            onTap: (){
                     ...
                     Padding(
                        ...
                        child: Material(
                         ...
                         webservices.UpdateGuessMusicFile(
                          ...
                          ):Text('Uploading ${(webservices_consumer.progress)}')
                        )
                    ),
                    ],
                  ),
